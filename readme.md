...
* A Python Implementation: Allows for fast prototyping and optionally uses VisPy for real-time GPU-accelerated volumetric rendering.
* A C++ Implementation: Serves as a high-performance algorithmic testbed. It uses Eigen and PocketFFT to explore memory-contiguous architectures and optimized linear algebra.
...
* [`/python/`](python/): A P³M + hydrodynamics cosmological simulation written in Python.
* [`/cpp/`](cpp/): A high-performance C++ equivalent.
