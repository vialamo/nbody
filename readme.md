...
* [`/viewer/`](viewer/): Contains a python viewer for the output files generated by the C++ simulation.
...
2.  **Run:** Navigate to the `viewer/` directory (or wherever the script is). Run the script passing an output folder generated by a simulation as an argument:
    ```bash
